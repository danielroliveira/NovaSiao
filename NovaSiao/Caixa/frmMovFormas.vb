...
#Region "ACAO DOS BOTOES"
	...
	Private Sub btnContaEscolher_Click(sender As Object, e As EventArgs) Handles btnContaEscolher.Click
		...
		'
		'--- verifica se conta do tipo operadora de cartao
		If frmConta.propConta_Escolha.ContaTipo <> 3 Then
			AbrirDialog("A Conta escolhida deve ser uma conta do tipo Operadora de Cartão...",
						"Conta Destino", frmDialog.DialogType.OK, frmDialog.DialogIcon.Exclamation)
			Exit Sub
		End If
		'
