...
Partial Class frmAPagarListPrint
    ...
    Private Sub InitializeComponent()
        ...
        Me.clAPagarBindingSource = New System.Windows.Forms.BindingSource(Me.components)
        Me.Panel1.SuspendLayout()
        CType(Me.clAPagarBindingSource, System.ComponentModel.ISupportInitialize).BeginInit()
        Me.SuspendLayout()
        '
        'Panel1
        '
        ...
        Me.lblTitulo.Text = "A Pagar Listagem"
        '
        'btnClose
        '
        ...
        ReportDataSource1.Name = "dtsAPagar"
        ReportDataSource1.Value = Me.clAPagarBindingSource
        Me.rptvLocal.LocalReport.DataSources.Add(ReportDataSource1)
        Me.rptvLocal.LocalReport.ReportEmbeddedResource = "NovaSiao.rptAPagarList.rdlc"
        ...
        '
        'clAPagarBindingSource
        '
        Me.clAPagarBindingSource.DataSource = GetType(CamadaDTO.clAPagar)
        '
        'frmAPagarListPrint
        '
        ...
        Me.Name = "frmAPagarListPrint"
        Me.Controls.SetChildIndex(Me.Panel1, 0)
        Me.Controls.SetChildIndex(Me.rptvLocal, 0)
        Me.Controls.SetChildIndex(Me.btnFechar, 0)
        Me.Panel1.ResumeLayout(False)
        CType(Me.clAPagarBindingSource, System.ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents clAPagarBindingSource As BindingSource
End Class
